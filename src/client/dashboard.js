  ...
  asset_types: [
    {
      ...
      description:
        "Financial institutions are entities that provide banking, investment, loan, or insurance products and services essential to economic development and asset management. They are central to the handling of money for individuals and businesses.",
      sub_types: [
        {
          name: "Bank",
          description:
            "Banks are licensed institutions that accept deposits, provide checking and savings accounts, offer loans, and facilitate financial transactions for the public and businesses.",
        },
        {
          name: "Non-Banking Financial Company (NBFC)",
          description:
            "NBFCs provide financial services like loans, asset financing, investment products, and insurance but do not hold a full banking license, often specializing in certain financial activities or customer segments.",
        },
        {
          name: "Insurance Company",
          description:
            "Insurance companies provide coverage against specific risks such as health, property, or life, collecting premiums and offering financial protection through policies.",
        },
        {
          name: "Mutual Fund",
          description:
            "Mutual funds pool money from investors to purchase a diversified portfolio of stocks, bonds, or other securities, managed by professional fund managers.",
        },
      ],
    },
    {
      name: "Real Estate",
      description:
        "Real estate assets relate to land and any structures attached to it, such as buildings. These assets can serve residential, commercial, industrial, or agricultural purposes and are significant for wealth creation and infrastructure.",
      sub_types: [
        {
          name: "Residential Property",
          description:
            "Residential properties include houses, apartments, condos, and other dwellings designed for people to live in.",
        },
        {
          name: "Commercial Property",
          description:
            "Commercial properties are used for business activities, such as office buildings, shopping centers, hotels, and retail outlets.",
        },
        {
          name: "Industrial Property",
          description:
            "Industrial properties are used for manufacturing, warehousing, logistics, or research and development activities.",
        },
        {
          name: "Land",
          description:
            "Raw or undeveloped land may be used for agriculture, future construction, or investment.",
        },
      ],
    },
    {
      name: "Legal Document",
      description:
        "Legal documents are formal records that establish, govern, or clarify legal rights and obligations. They are critical in business, property, and personal affairs.",
      sub_types: [
        {
          name: "Contract",
          description:
            "Contracts are agreements between parties that create legally binding obligations, outlining responsibilities and remedies.",
        },
        {
          name: "Deed",
          description:
            "Deeds are documents evidencing the transfer or creation of legal rights in property, often relating to real estate.",
        },
        {
          name: "Will",
          description:
            "A will is a legal statement of an individual's wishes regarding distribution of assets after death.",
        },
        {
          name: "Affidavit",
          description:
            "Affidavits are written sworn statements used as evidence in legal proceedings.",
        },
      ],
    },
  ],
  people: [
    {
      name: "Relationships",
      description:
        "Family members and trusted individuals who play a role in your life and asset management.",
      sub_types: [
        { name: "Spouse", description: "Your legally married partner." },
        {
          name: "Child",
          description: "Your biological or adopted son or daughter.",
        },
    ...
    },
    {
      ...
      sub_types: [
        {
          name: "Attorney",
          description: "A lawyer who provides legal advice and representation.",
        },
        { name: "Advisor", description: "A financial advisor or planner." },
        {
          name: "Notary Public",
          description: "An official who authenticates documents.",
        },
        {
          name: "Judge",
          description:
        ...
        },
        {
          ...
          description: "An officer responsible for compliance and governance.",
        },
      ],
    },
  ],
  geographies: [
    {
      name: "India",
      description:
        "India has a mixed legal and financial system based on common law with specific regulatory frameworks for banking, finance, property transactions, and legal documentation.",
      icon: "🇮🇳",
    },
    {
      name: "Canada",
      description:
        "Canada combines common law (except Quebec's civil law) with modern regulatory systems, offering a robust environment for finance, real estate, and legal processes.",
      icon: "🇨🇦",
    },
    {
      name: "United Kingdom",
      description:
        "The UK has a long-established common law system and mature markets for finance, real estate, and legal services, with well-defined legal document and asset handling.",
      icon: "🇬🇧",
    },
    {
      name: "United States",
      description:
        "The USA has a federal system with common law roots, advanced financial and real estate markets, and diverse legal and regulatory practices across states.",
      icon: "🇺🇸",
    },
    {
      name: "Australia",
      description:
        "Australia operates under common law and offers vigorous financial, property, and legal frameworks, supported by national and state regulations.",
      icon: "🇦🇺",
    },
    {
      name: "New Zealand",
      description:
        "New Zealand has a common law heritage and modernized frameworks for finance, real estate, and legal proceedings, ensuring transparency in asset management.",
      icon: "🇳🇿",
    },
  ],
};
    ...
    ?.addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(
            errorData.error?.message || "Failed to save asset to Google Sheets"
          );
        }
    ...
    ?.addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (!response.ok) {
          const errorData = await response.json();
          throw new Error(
            errorData.error?.message || "Failed to save person to Google Sheets"
          );
        }
  ...
  try {
    ...
    assets.forEach((asset) => {
      categoryBreakdown[asset.category] =
        (categoryBreakdown[asset.category] || 0) + 1;
    });
            ...
            <tr>
                ...
                <td>
                    <div class="table-actions">
                        <button class="btn-icon" onclick="editAsset(${
                          asset.id
                        })">
                        ...
                        <button class="btn-icon delete" onclick="deleteAsset(${
                          asset.id
                        })">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
function editAsset(id) {
  ...
  document.getElementById("assetAccessDetails").value =
    asset.accessDetails || "";
...
function renderPeople(filter = "") {
  try {
    ...
    tbody.innerHTML = filteredPeople
      .map((person) => {
        ...
        <tr>
            ...
            <td>
                <div class="table-actions">
                    ...
                    <button class="btn-icon delete" onclick="deletePerson(${
                      person.id
                    })">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="3 6 5 6 21 6"/>
    ...
    async () => {
      try {
        ...
        if (!response.ok) {
          const errorData = await response.json();
          throw new Error(
            errorData.error?.message || "Failed to delete person"
          );
        }
        ...
        <tr>
            ...
            <td>
                <div class="table-actions">
                    ...
                    <button class="btn-icon delete" onclick="removeDocumentAccess(${doc.id})">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="3 6 5 6 21 6"/>
                            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/>
                        </svg>
...
function removeDocumentAccess(docId) {
  ...
  showConfirmModal(
    ...
    `Are you sure you want to remove access to "${doc.name}"? The recipient will no longer be able to view this document.`,
    async () => {
      try {
        // Remove from local array
        documents = documents.filter((d) => String(d.id) !== String(docId));

        // Save updated documents to API (which will replace all documents with current array)
        ...
        if (!response.ok) {
          const errorData = await response.json();
          throw new Error(errorData.error?.message || "Failed to remove document access");
        }

        renderDocuments();
        renderDashboard();
        closeModal("confirmModal");
        showToast("Document access removed successfully!", "success");
      } catch (error) {
...
function renderKnowledgeBase(filter = "") {
  ...
  Object.entries(knowledgeBase).forEach(([section, items]) => {
    ...
    html += `<div class="knowledge-section"><h3>${section
      .replace("_", " ")
      .toUpperCase()}</h3><div class="knowledge-grid">`;
      ...
      if (match) {
        ...
        html += `
                    <div class="knowledge-card" onclick="openKnowledgeModal('${section}', ${index})">
                        ...
                        <p class="knowledge-description">${desc.substring(
                          0,
                          100
                        )}...</p>
                    </div>
...
function renderSharedItems(filter = "") {
  ...
  try {
      ...
      .map(
        (item) => `
            <tr>
                ...
                <td>${item.owner}</td>
                <td><span class="info-badge">${
                  item.accessLevel || "Viewer"
                }</span></td>
                <td>${item.lastModified}</td>
                <td>
                    <div class="table-actions">
                        <button class="btn-icon" onclick="showToast('This will open ${
                          item.name
                        } Sheet', 'info')">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>
    ...
    tbody.innerHTML =
      '<tr><td colspan="5">Error loading shared items</td></tr>';
  }
}
...
function confirmDeleteAccount() {
  showConfirmModal(
    ...
    () => {
      closeModal("confirmModal");
      showToast(
        "Account deletion requested (demo only). In production, this would delete your account.",
        "info"
      );
    }
  );
